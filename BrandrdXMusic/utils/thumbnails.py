...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("BrandrdXMusic/assets/font.ttf", 32)
        regular_font = ImageFont.truetype("BrandrdXMusic/assets/font2.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "BrandrdXMusic/assets/play_icons.png"
    ...
    font = ImageFont.truetype("BrandrdXMusic/assets/font.ttf", 28)  # 
    text = "ISTKHAR BOTS"
